...
| `or-policy.apnnue` | Case selection, constructors, composed evidence and visible premises | 430 unimath proof-bound choices, continuing the earlier standard-library model |
...
nineteen composed-evidence and 384 premise choices. Other OR families and untrained
...
- Current library OR training: `bda314ea4835f1cacd254628a1d5c8adb0268409f6591ebf7dc459327a5d8c79`
...
snapshots of 46, 86, 159, 276, 375, 382, 394, 403, 412 and now 430 choices. Earlier weights
...
Through the actual inference router, recorded-choice agreement is 212/430 on
training data, versus 200/430 for the parent. Internal validation remains
11/12, while its choice loss rises from 0.654905 to 0.703349. The raw
...
Full and incremental Python inference agree exactly on all 64,508 training
...
in 15.26 seconds, rotating correspondence in 8.81, the natural-number semiring
in 16.19, the list semiring in 16.65, generic recursive families in 2.18 and
W-type destructors/fold/map in 3.34. Action and checker counts match the same
runtime's preceding model checks on all six. These are working-capability checks, not evidence that
...
`docs/reviews/e3-dependent-evidence-continuation.md` records this continuation. Earlier
